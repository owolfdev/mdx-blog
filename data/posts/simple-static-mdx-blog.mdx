...
date: "2024-04-21"
description: >-
  Creating a static MDX blog in Next.js 14 involves several steps, including
  setting up your Next.js environment, creating MDX files, and configuring your
  pages to render these files.
categories:
  - web
  - development
  - javascript
...
path: simple-static-mdx-blog.mdx
---
