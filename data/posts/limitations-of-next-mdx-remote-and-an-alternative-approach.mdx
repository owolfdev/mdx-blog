...
Check out this tutorial by **Alex Chan** for a detailed guide on setting up a blog with Next.js App Router and MDX: [Building a blog with Next.js App Router and MDX](https://www.alexchantastic.com/building-a-blog-with-next-and-mdx).
