...
[**MDX Blog** (mdxblog.io](https://mdxblog.io)) is a platform built with the latest web technologies, offering a unique blogging experience. MDX Blog is a simple template for creating blogs using MDX (Markdown + JSX) and Next.js 14. It's a good solution for those who appreciate the ease of Markdown and the power of React components. Content management is done on your local machine.
