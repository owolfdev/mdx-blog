...
1. [Introduction to Static Rendering](#introduction-to-static-rendering)
2. [How MDX is Integrated into MDXBlog](#how-mdx-is-integrated-into-mdxblog)
3. [Understanding the Build Process](#understanding-the-build-process)
4. [Exploring the Key Components](#exploring-the-key-components)
   - [MDX Content Component](#mdx-content-component)
   - [Custom MDX Components](#custom-mdx-components)
5. [The Role of `generateMetadata`](#the-role-of-generatemetadata)
6. [Why Static Rendering Matters](#why-static-rendering-matters)
