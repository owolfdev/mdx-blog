export const metadata = {
  ...
  description: "Markdown and MDX, paired with Vim motions, offer a streamlined, efficient workflow for content creation that prioritizes keyboard use over mouse interactions.",
  category: ["Web Development"],
  tags: ["vim", "vscode", "motions", "mdx"],
  modifiedDate: "2024-08-25T22:17:49.894Z",
  image: null,
  draft: false,
  relatedPosts: [""]
};
