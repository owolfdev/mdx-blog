export const metadata = {
  ...
  description: "In this article, we will walk you through the process of creating a like button for an MDX-based Next.js application.",
  category: ["Web Development"],
  tags: ["likes", "vercel", "postgres"],
  modifiedDate: "2024-08-27T20:11:54.018Z",
  image: null,
  draft: false,
  relatedPosts: ["using-and-styling-custom-components-in-mdx-content", "import-components-to-mdx", ""]
};
