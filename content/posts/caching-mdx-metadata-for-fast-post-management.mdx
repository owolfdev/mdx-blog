export const metadata = {
  id: "awcSdUnPsCr9B7zk5vzrLV",
  type: "blog",
  title: "Caching MDX Metadata for Fast Post Management",
  author: "O Wolfson",
  publishDate: "2024-08-28",
  description:
    "By extracting metadata from your MDX files and storing it in a cache, you can dramatically speed up operations like listing, pagination, and searching.",
  category: ["Web Development"],
  tags: ["mdx", "caching"],
  modifiedDate: "2024-08-25T10:56:41.121Z",
  image: null,
  draft: false,
  relatedPosts: [""],
};
...
#### **2. Simplified `generatePostCache` Function**
