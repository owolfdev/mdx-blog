export const metadata = {
  id: "v9P6fALqG4NVA8CPDKrUwo",
  type: "blog",
  title: "Optimizing MDX for SEO",
  author: "O Wolfson",
  publishDate: "2024-02-10",
  description:
    "This post discusses strategies for enhancing the SEO of your MDX blog posts, focusing on metadata management and content structuring.",
  category: ["Web Development"],
  tags: ["seo", "google", "search", "indexing", "ranking"],
};
