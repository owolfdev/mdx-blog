export const metadata = {
  id: "3952207e-5007-4646-a859-dae48f85bf2c",
  type: "blog",
  title: "Simple Static MDXBlog",
  author: "O. Wolfson",
  publishDate: "2024-04-21",
  description:
    "Creating a static MDXblog in Next.js 14 involves several steps, including setting up your Next.js environment, creating MDX files, and configuring your pages to render these files.",
  ...
  return (
    <div>
      <div className="flex flex-col gap-8">
        <h1 className="font-bold text-4xl">Next.js MDXBlog</h1>
        <div>
