export const metadata = {
  ...
  description: "Static rendering is a powerful feature of Next.js that allows you to pre-generate HTML pages at build time.",
  categories: ["Web Development"],
  tags: ["mdx", "static", "blog", "rendering"],
  modifiedDate: "2024-08-31T02:09:04.664Z",
  image: null,
  draft: false,
  relatedPosts: [""]
};
