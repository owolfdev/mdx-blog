export const metadata = {
  ...
  description:
    "Next.js provides seamless support for MDX through the @next/mdx package, allowing developers to write and render MDX content in various ways.",
  categories: ["Web Development"],
  tags: ["mdx", "markdown", "next.js", "react", "static", "blog"],
  modifiedDate: "2025-01-08T22:44:58.964Z",
  image: null,
  draft: false,
  relatedPosts: [],
};
