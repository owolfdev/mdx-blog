export const metadata = {
  ...
  description: "When working with images in a Next.js project, using the built-in next/image component is the recommended approach for optimized loading, automatic resizing, and improved performance.",
  categories: ["Web Development"],
  tags: ["image", "images"],
  modifiedDate: "2025-12-20T01:33:15.027Z",
  image: null,
  draft: false,
  relatedPosts: []
};
