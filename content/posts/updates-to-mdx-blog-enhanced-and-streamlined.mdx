export const metadata = {
  id: "b2a561d0-341f-4997-94fe-3aa25c78cbf5",
  type: "blog",
  title: "Updates to MDXBlog: Enhanced and Streamlined",
  author: "O Wolfson",
  publishDate: "2024-08-14",
  description: "Major updates to MDXBlog that brings new features and improvements, aimd at making our development experience even better.",
  categories: ["Web Development"],
  tags: ["mdx", "update", "version", "blog", "app"],
  modifiedDate: "2024-08-27T20:16:15.033Z",
  image: null,
  draft: false,
  relatedPosts: ["nextjs-switch-api-to-server-actions", "metadata-object-components-in-next-js-mdx-blogs", "next-mdx-remote-limitations"]
};
