export const metadata = {
  ...
  description:
    "Our mission is to take the friction out of content creation. We wanted a blogging platform that was easy to use, without a lot of complications, that makes content creation a pleasure, so we built one.",
