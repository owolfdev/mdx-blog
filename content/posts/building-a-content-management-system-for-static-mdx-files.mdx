export const metadata = {
  id: "4VUVUwCWAmE4RxANNBGEd4",
  type: "blog",
  title: "Building a Content Management System for Static MDX Files",
  author: "O Wolfson",
  publishDate: "2024-06-04",
  description:
    "In this article, we'll walk you through creating a content management system (CMS) for our MDX Blog, where blog posts are stored as local static files. We'll cover saving posts, generating a cache for efficient data retrieval, and handling form submissions for new blog entries.",
...
4. List blog post titles on the home screen with edit and delete functionality.
...
export function saveFileLocally(data) {
  ...
  // Format the categories and tags
...
`;
  ...
  // Write the file and update the cache
  fs.writeFile(filePath, fileContent, (err) => {
    if (err) {
      console.error("Error writing file:", err);
    } else {
      generatePostsCache(); // Regenerate the cache after saving the file
      // Open the saved file in Visual Studio Code
