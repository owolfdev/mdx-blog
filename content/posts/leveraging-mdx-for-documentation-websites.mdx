export const metadata = {
  id: "63491e0a-5c8a-4c40-b627-d7709792570d",
  type: "blog",
  title: "Leveraging MDX for Docs Websites",
  author: "O Wolfson",
  publishDate: "2024-03-01",
  description:
    "This article explores how MDX can be effectively utilized to build documentation websites, focusing on features like table of contents, code highlighting, and more.",
