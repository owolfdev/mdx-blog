export const metadata = {
  ...
  description:
    "In this post, we want to share why we chose to use Metadata Objects/Components over frontmatter for handling MDX metadata in our latest experiments.",
...
In this post, we want to share why we chose to use Metadata Objects/Components over frontmatter for handling metadata in our MDX files.
